...
%  Detailed explanation goes here
   ...
   if   SM3<15
       f_bleedgas=1;
   while SM3<15
       Wboo=Wboo*(1-Gasbleed);
       Gasbleed=Gasbleed+0.01;
       SM3=surgmargin(Wboo,PRboo,NBcor,ScallPRboo, ScallWboo,'GBoosterWAc.txt','GBoosterPr.txt',12,10,Theta,Delta); 
    ...
    if traditional==0%%
       [Tboo,Tbpoi,Deltp1,Deltp2,mass1,mass2,youxd1,youxd2,zyxd1]=intercooler_guannew(Tfano,Tboo,Pboo,Pfano,Wfano,icper,BPR);
% 	  exchanger;
       Pboo = Pfano*PRboo*sigfc-Deltp2;%booster出口总压
    end%%
