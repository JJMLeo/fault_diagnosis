function [Pt_out,Tt_out,W_out,V,Ma,PR_Real,Ps_out]= ByPass(Pt_in,Tt_in,Pamb,DesignResult_ByPass)
%外涵道设计点参数
d_Sigma_BP=DesignResult_ByPass(1);
A_BP=DesignResult_ByPass(2);
...
%外涵道出口空气流量
W_out=K_BP*A_BP*q*Pt_out/sqrt(Tt_out);
