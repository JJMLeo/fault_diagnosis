...
static const char * c6_debug_family_names[22] = { "f_Real", "Abs_Error",
  "T4s_ini", "h3", "ScallEffb", "Effb", "f_Cacul", "h4_E", "Effb_E", "f_Cacul_E",
  "error", "D_error", "nargin", "nargout", "P3s", "Hu", "T3s", "Wf", "Wa3",
  "T4s", "h4", "Sfcn4" };
...
static void initialize_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void initialize_params_c6_TSE_Path(SFc6_TSE_PathInstanceStruct
  *chartInstance);
static void enable_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void disable_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_TSE_Path(SFc6_TSE_PathInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_TSE_Path(SFc6_TSE_PathInstanceStruct
  *chartInstance);
static void set_sim_state_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance,
  const mxArray *c6_st);
static void finalize_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void sf_gateway_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void mdl_start_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_chartstep_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static void initSimStructsc6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance);
static real_T c6_gashi(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_T,
  real_T c6_FuelAirRatio);
static real_T c6_LookupEffb(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_Tburno, real_T c6_Tcomo, real_T c6_Pcomo);
static real_T c6_Sfcn_Ts(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_f,
  real_T c6_T);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_TSE_PathInstanceStruct *chartInstance,
  const mxArray *c6_b_Sfcn4, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_TSE_PathInstanceStruct *chartInstance,
...
static void c6_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static real_T c6_interp2(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_varargin_4, real_T c6_varargin_5);
static void c6_narginchk(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_StringToMethodID(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_eml_scalar_eg(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_eml_switch_helper(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_interp2_validate(SFc6_TSE_PathInstanceStruct *chartInstance,
  uint8_T c6_METHOD);
static boolean_T c6_isnan(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_x);
static void c6_scalarEg(SFc6_TSE_PathInstanceStruct *chartInstance);
static real_T c6_interp2_dispatch(SFc6_TSE_PathInstanceStruct *chartInstance,
  real_T c6_Xq, real_T c6_Yq);
static real_T c6_interp2_spline(SFc6_TSE_PathInstanceStruct *chartInstance,
  real_T c6_Xq, real_T c6_Yq);
static real_T c6_TensorInterp23(SFc6_TSE_PathInstanceStruct *chartInstance,
  real_T c6_varargin_4, real_T c6_varargin_5);
static real_T c6_TensorGriddedInterp(SFc6_TSE_PathInstanceStruct *chartInstance,
  real_T c6_varargin_4, real_T c6_varargin_5);
static void c6_spline(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_y
                      [225], c6_sBa2ou9sFCIEvqqnq4mGCgH *c6_output);
static void c6_splinepp(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_y
  [225], c6_sBa2ou9sFCIEvqqnq4mGCgH *c6_pp);
static void c6_chckxy(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_y
                      [225]);
static void c6_b_eml_scalar_eg(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_pwchcore(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_x
  [15], real_T c6_y[225], real_T c6_s[225], real_T c6_dx[14], real_T c6_divdif
  [210], c6_sBa2ou9sFCIEvqqnq4mGCgH *c6_pp);
static void c6_ppval(SFc6_TSE_PathInstanceStruct *chartInstance,
                     c6_sBa2ou9sFCIEvqqnq4mGCgH *c6_pp, real_T c6_x, real_T
                     c6_v[15]);
static int32_T c6_bsearch(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_x[15], real_T c6_xi);
static void c6_b_narginchk(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_b_spline(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_y
  [15], c6_stVqs9TyzBMV0s0DmfB5u9G *c6_output);
static void c6_b_splinepp(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_y[15], c6_stVqs9TyzBMV0s0DmfB5u9G *c6_pp);
static void c6_b_chckxy(SFc6_TSE_PathInstanceStruct *chartInstance, real_T c6_y
  [15]);
static void c6_c_eml_scalar_eg(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_b_pwchcore(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_x[15], real_T c6_y[15], real_T c6_s[15], real_T c6_dx[14], real_T
  c6_divdif[14], c6_stVqs9TyzBMV0s0DmfB5u9G *c6_pp);
static real_T c6_b_ppval(SFc6_TSE_PathInstanceStruct *chartInstance,
  c6_stVqs9TyzBMV0s0DmfB5u9G *c6_pp, real_T c6_x);
static real_T c6_interp1(SFc6_TSE_PathInstanceStruct *chartInstance, real_T
  c6_varargin_1[181], real_T c6_varargin_2[181], real_T c6_varargin_3);
static void c6_b_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_d_eml_scalar_eg(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_c_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_d_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_b_StringToMethodID(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_e_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_f_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_g_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_h_assert(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_eml_error(SFc6_TSE_PathInstanceStruct *chartInstance);
static void c6_b_eml_error(SFc6_TSE_PathInstanceStruct *chartInstance);
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_TSE_PathInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_TSE_PathInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_TSE_Path, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_TSE_PathInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_TSE_PathInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_TSE_PathInstanceStruct *chartInstance);
...
static void initialize_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_TSE_Path = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_b_hoistedGlobal = *chartInstance->c6_T4s;
  ...
  c6_d_hoistedGlobal = chartInstance->c6_is_active_c6_TSE_Path;
  ...
  const mxArray *c6_st)
{
  ...
  *chartInstance->c6_T4s = c6_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c6_u, 1)), "T4s");
  *chartInstance->c6_h4 = c6_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c6_u, 2)), "h4");
  chartInstance->c6_is_active_c6_TSE_Path = c6_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 3)), "is_active_c6_TSE_Path");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_TSE_Path(chartInstance);
...
static void sf_gateway_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_P3s, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_Hu, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_T3s, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_Wf, 3U);
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_TSE_Path(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_TSE_PathMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_T4s, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c6_Wa3, 5U);
...
static void c6_chartstep_c6_TSE_Path(SFc6_TSE_PathInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal = *chartInstance->c6_P3s;
  c6_b_hoistedGlobal = *chartInstance->c6_Hu;
  c6_c_hoistedGlobal = *chartInstance->c6_T3s;
  c6_d_hoistedGlobal = *chartInstance->c6_Wf;
  c6_e_hoistedGlobal = *chartInstance->c6_Wa3;
  c6_b_P3s = c6_hoistedGlobal;
  c6_b_Hu = c6_b_hoistedGlobal;
  c6_b_T3s = c6_c_hoistedGlobal;
  c6_b_Wf = c6_d_hoistedGlobal;
  c6_b_Wa3 = c6_e_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_Abs_Error, 1U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_T4s_ini, 2U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 13U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_b_P3s, 14U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_b_Hu, 15U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_b_T3s, 16U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_b_Wf, 17U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_b_Wa3, 18U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_b_T4s, 19U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  ...
  c6_h3 = c6_gashi(chartInstance, c6_b_T3s, 0.0);
  ...
  while (CV_EML_WHILE(0, 1, 0, c6_Abs_Error > 1.0E-9)) {
    ...
    c6_b_h4 = c6_gashi(chartInstance, c6_T4s_ini, c6_f_Real);
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 11);
    c6_Effb = c6_LookupEffb(chartInstance, c6_T4s_ini, c6_b_T3s, c6_b_P3s);
    ...
    c6_h4_E = c6_gashi(chartInstance, c6_T4s_ini * 0.99999, c6_f_Real);
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 15);
    c6_Effb_E = c6_LookupEffb(chartInstance, c6_T4s_ini * 0.99999, c6_b_T3s,
      c6_b_P3s);
  ...
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c6_b_T4s, 288.15, -1, 3U,
        c6_b_T4s <= 288.15))) {
  ...
  c6_b_h4 = c6_gashi(chartInstance, c6_b_T4s, c6_f_Real);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 31);
  c6_b_Sfcn4 = c6_Sfcn_Ts(chartInstance, c6_f_Real, c6_b_T4s);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -31);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c6_T4s = c6_b_T4s;
  ...
  c6_chartNumber, uint32_T c6_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c6_chartNumber, c6_instanceNumber, 1U,
    sf_debug_get_script_id(
    "I:\\MATLABWORK\\GTFEngine\\FunctionsLibrary\\LookupEffb.m"));
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u;
  const mxArray *c6_y = NULL;
  SFc6_TSE_PathInstanceStruct *chartInstance;
  chartInstance = (SFc6_TSE_PathInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_TSE_Path_get_eml_resolved_functions_info(void)
{
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTFEngine/FunctionsLibrary/LookupEffb.m"), "resolved",
                  "resolved", 9);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTFEngine/FunctionsLibrary/LookupEffb.m"), "context",
                  "context", 10);
  ...
  const mxArray *c6_b_is_active_c6_TSE_Path, const char_T *c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_TSE_Path), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_TSE_Path);
  return c6_y;
}
...
static void init_simulink_io_address(SFc6_TSE_PathInstanceStruct *chartInstance)
{
  chartInstance->c6_P3s = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c6_Hu = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c6_T3s = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c6_Wf = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    3);
  chartInstance->c6_T4s = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c6_Wa3 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 4);
...
void sf_c6_TSE_Path_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(957404353U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3708290113U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2840017260U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3346617510U);
}

mxArray* sf_c6_TSE_Path_get_post_codegen_info(void);
mxArray *sf_c6_TSE_Path_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1RIb79VzhEHG1Am7puFPkD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_TSE_Path_get_post_codegen_info();
...
mxArray *sf_c6_TSE_Path_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_TSE_Path_jit_fallback_info(void)
{
...
mxArray *sf_c6_TSE_Path_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_TSE_Path(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"Sfcn4\",},{M[1],M[5],T\"T4s\",},{M[1],M[10],T\"h4\",},{M[8],M[0],T\"is_active_c6_TSE_Path\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_TSE_Path_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_TSE_PathInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"P3s");
          _SFD_SET_DATA_PROPS(1,1,1,0,"Hu");
          _SFD_SET_DATA_PROPS(2,1,1,0,"T3s");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Wf");
          _SFD_SET_DATA_PROPS(4,2,0,1,"T4s");
          _SFD_SET_DATA_PROPS(5,1,1,0,"Wa3");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,616,630,-1,650);
        _SFD_CV_INIT_EML_WHILE(0,1,0,187,208,602);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,619,630,-1,3);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(7,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c6_sf_marshallOut,(MexInFcnForType)c6_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c6_P3s);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c6_Hu);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c6_T3s);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c6_Wf);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c6_T4s);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c6_Wa3);
...
{
  return "U6i44rTG2qq5GR0eX6TWkD";
}

static void sf_opaque_initialize_c6_TSE_Path(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_TSE_PathInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
  initialize_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_TSE_Path(void *chartInstanceVar)
{
  enable_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_TSE_Path(void *chartInstanceVar)
{
  disable_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_TSE_Path(void *chartInstanceVar)
{
  sf_gateway_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_TSE_Path(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_TSE_Path(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_TSE_Path(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_TSE_PathInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_TSE_Path((SFc6_TSE_PathInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_TSE_Path(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_TSE_Path((SFc6_TSE_PathInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_TSE_Path(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4176855777U));
  ssSetChecksum1(S,(1541174015U));
  ssSetChecksum2(S,(4218632892U));
  ssSetChecksum3(S,(2552621057U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_TSE_Path(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_TSE_Path(SimStruct *S)
{
  SFc6_TSE_PathInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_TSE_PathInstanceStruct *)utMalloc(sizeof
    (SFc6_TSE_PathInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_TSE_PathInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_TSE_Path;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_TSE_Path;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_TSE_Path;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_TSE_Path;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_TSE_Path;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_TSE_Path;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_TSE_Path;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_TSE_Path;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_TSE_Path;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_TSE_Path;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_TSE_Path;
...
void c6_TSE_Path_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_TSE_Path(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_TSE_Path(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_TSE_Path(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_TSE_Path_method_dispatcher.\n"
