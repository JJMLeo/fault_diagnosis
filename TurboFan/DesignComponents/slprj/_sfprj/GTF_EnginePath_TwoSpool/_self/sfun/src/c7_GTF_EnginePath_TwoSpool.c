...
static const char * c7_debug_family_names[10] = { "WcoolLPT_NGV", "nargin",
  "nargout", "Tt44", "W44", "WcoolLPT", "Tt_Z3", "Wf", "Tt45", "Sfcn45" };

static const char * c7_b_debug_family_names[9] = { "b_FuelAirRatio", "TE", "Hia",
  "Hif", "nargin", "nargout", "T", "FuelAirRatio", "Hi" };

static const char * c7_c_debug_family_names[10] = { "a", "b", "error", "hguess",
  "Z", "nargin", "nargout", "h", "f", "Tt" };

static const char * c7_d_debug_family_names[9] = { "T_lib", "psi_lib",
  "thetapsi_lib", "thetapsi", "nargin", "nargout", "f", "T", "Sfcn" };

static const char * c7_e_debug_family_names[13] = { "f", "Wcool_NGV", "f_Mix",
  "h_Mix", "nargin", "nargout", "Tt_in", "W_in", "Tt_Cool_in", "Wcool_in", "Wf",
  "Tt_out", "Sfcn_out" };

/* Function Declarations */
static void initialize_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initialize_params_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void enable_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void disable_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void set_sim_state_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void sf_gateway_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void mdl_start_c7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initSimStructsc7_GTF_EnginePath_TwoSpool
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c7_CoolingCal_NGV(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c7_Tt_in, real_T c7_W_in, real_T c7_Tt_Cool_in, real_T
  c7_Wcool_in, real_T c7_b_Wf, real_T *c7_Tt_out, real_T *c7_Sfcn_out);
static real_T c7_gashi(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
  real_T c7_T, real_T c7_FuelAirRatio);
static real_T c7_Sfcn_Ts(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c7_f, real_T c7_T);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, const mxArray *c7_b_Sfcn45, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
...
static void c7_eml_scalar_eg(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c7_interp1(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c7_varargin_3);
static real_T c7_interp1_work(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c7_xi);
static void c7_StringToMethodID(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static int32_T c7_intmin(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c7_eml_error(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c7_b_eml_error(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c7_b_interp1(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c7_varargin_1[181], real_T c7_varargin_2[181], real_T
  c7_varargin_3);
static void c7_flip(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                    real_T c7_x[181], real_T c7_b_x[181]);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c7_b_is_active_c7_GTF_EnginePath_TwoSpool, const
  char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_flip(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                      real_T c7_x[181]);
static void init_dsm_address_info(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance);
  ...
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_GTF_EnginePath_TwoSpool = 0U;
}
  ...
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = *chartInstance->c7_Sfcn45;
  c7_u = c7_hoistedGlobal;
  c7_b_y = NULL;
  sf_mex_assign(&c7_b_y, sf_mex_create("y", &c7_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c7_y, 0, c7_b_y);
  c7_b_hoistedGlobal = *chartInstance->c7_Tt45;
  c7_b_u = c7_b_hoistedGlobal;
  c7_c_y = NULL;
  sf_mex_assign(&c7_c_y, sf_mex_create("y", &c7_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c7_y, 1, c7_c_y);
  c7_c_hoistedGlobal = chartInstance->c7_is_active_c7_GTF_EnginePath_TwoSpool;
   ...
   *c7_st)
{
  ...
  *chartInstance->c7_Sfcn45 = c7_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c7_u, 0)), "Sfcn45");
  *chartInstance->c7_Tt45 = c7_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c7_u, 1)), "Tt45");
  chartInstance->c7_is_active_c7_GTF_EnginePath_TwoSpool = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 2)),
     "is_active_c7_GTF_EnginePath_TwoSpool");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_GTF_EnginePath_TwoSpool(chartInstance);
  ...
  (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  real_T c7_b_Tt44;
  real_T c7_b_W44;
  real_T c7_b_WcoolLPT;
  real_T c7_b_Tt_Z3;
  real_T c7_b_Wf;
  uint32_T c7_debug_family_var_map[10];
  real_T c7_WcoolLPT_NGV;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_Tt44, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_W44, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_WcoolLPT, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_Tt_Z3, 3U);
  chartInstance->c7_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 6U, chartInstance->c7_sfEvent);
  c7_hoistedGlobal = *chartInstance->c7_Tt44;
  c7_b_hoistedGlobal = *chartInstance->c7_W44;
  c7_c_hoistedGlobal = *chartInstance->c7_WcoolLPT;
  c7_d_hoistedGlobal = *chartInstance->c7_Tt_Z3;
  c7_e_hoistedGlobal = *chartInstance->c7_Wf;
  c7_b_Tt44 = c7_hoistedGlobal;
  c7_b_W44 = c7_b_hoistedGlobal;
  c7_b_WcoolLPT = c7_c_hoistedGlobal;
  c7_b_Tt_Z3 = c7_d_hoistedGlobal;
  c7_b_Wf = c7_e_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c7_debug_family_names,
    c7_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_WcoolLPT_NGV, 0U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_nargout, 2U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_Tt44, 3U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_W44, 4U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_WcoolLPT, 5U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_Tt_Z3, 6U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_Wf, 7U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_Tt45, 8U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_Sfcn45, 9U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, 2);
  c7_WcoolLPT_NGV = c7_b_WcoolLPT * 0.33333333333333331;
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, 3);
  c7_CoolingCal_NGV(chartInstance, c7_b_Tt44, c7_b_W44, c7_b_Tt_Z3,
                    c7_WcoolLPT_NGV, c7_b_Wf, &c7_c_Tt45, &c7_c_Sfcn45);
  c7_b_Tt45 = c7_c_Tt45;
  c7_b_Sfcn45 = c7_c_Sfcn45;
  _SFD_EML_CALL(0U, chartInstance->c7_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c7_Tt45 = c7_b_Tt45;
  *chartInstance->c7_Sfcn45 = c7_b_Sfcn45;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 6U, chartInstance->c7_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_GTF_EnginePath_TwoSpoolMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_Tt45, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_Wf, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_Sfcn45, 6U);
}
  ...
  c7_Wcool_in, real_T c7_b_Wf, real_T *c7_Tt_out, real_T *c7_Sfcn_out)
{
  ...
  real_T c7_y_x;
  real_T c7_ab_x;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 13U, 13U, c7_e_debug_family_names,
    c7_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_f, 0U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Wcool_NGV, 1U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_f_Mix, 2U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_h_Mix, 3U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_nargout, 5U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Tt_in, 6U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_W_in, 7U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Tt_Cool_in, 8U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Wcool_in, 9U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_Wf, 10U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_Tt_out, 11U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_Sfcn_out, 12U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, 3);
  c7_A = c7_b_Wf;
  c7_B = c7_W_in - c7_b_Wf;
  c7_x = c7_A;
  c7_y = c7_B;
  c7_b_x = c7_x;
  c7_b_y = c7_y;
  ...
  c7_Wcool_NGV = c7_Wcool_in;
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, 9);
  c7_b_A = c7_b_Wf;
  c7_b_B = (c7_W_in + c7_Wcool_NGV) - c7_b_Wf;
  c7_d_x = c7_b_A;
  c7_d_y = c7_b_B;
  c7_e_x = c7_d_x;
  c7_e_y = c7_d_y;
  c7_f_x = c7_e_x;
  c7_f_y = c7_e_y;
  c7_f_Mix = c7_f_x / c7_f_y;
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, 12);
  c7_c_A = c7_W_in * c7_gashi(chartInstance, c7_Tt_in, c7_f) + c7_Wcool_NGV *
    c7_gashi(chartInstance, c7_Tt_Cool_in, 0.0);
  c7_c_B = c7_W_in + c7_Wcool_NGV;
  c7_g_x = c7_c_A;
  c7_g_y = c7_c_B;
  c7_h_x = c7_g_x;
  c7_h_y = c7_g_y;
  c7_i_x = c7_h_x;
  c7_i_y = c7_h_y;
  c7_h_Mix = c7_i_x / c7_i_y;
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, 15);
  c7_h = c7_h_Mix;
  c7_b_f = c7_f_Mix;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c7_c_debug_family_names,
    c7_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_a, 0U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b, 1U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_error, 2U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_hguess, 3U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Z, 4U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_nargin, 5U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_nargout, 6U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_h, 7U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_f, 8U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c7_Tt_out, 9U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 2);
  c7_a = 0.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 3);
  c7_b = 3000.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 4);
  c7_error = 1.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 5);
  while (CV_SCRIPT_WHILE(2, 0, c7_error > 1.0E-12)) {
    ...
    c7_l_x = c7_k_x;
    c7_j_y = c7_l_x / 2.0;
    c7_hguess = c7_gashi(chartInstance, c7_j_y, c7_b_f);
    _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 7);
    c7_e_A = c7_hguess - c7_h;
    c7_d_B = c7_h;
    c7_m_x = c7_e_A;
    c7_k_y = c7_d_B;
    c7_n_x = c7_m_x;
    ...
    c7_o_x = c7_n_x;
    c7_m_y = c7_l_y;
    c7_n_y = c7_o_x / c7_m_y;
    c7_p_x = c7_n_y;
    c7_q_x = c7_p_x;
    c7_error = muDoubleScalarAbs(c7_q_x);
    _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 8);
    c7_Z = c7_hguess - c7_h;
    _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 9);
    if (CV_SCRIPT_IF(2, 0, CV_RELATIONAL_EVAL(14U, 2U, 0, c7_Z, 0.0, -1, 5U,
          c7_Z >= 0.0))) {
      ...
      _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 12);
      c7_g_A = c7_a + c7_b;
      c7_u_x = c7_g_A;
      c7_v_x = c7_u_x;
      c7_w_x = c7_v_x;
  ...
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, 15);
  c7_h_A = c7_a + c7_b;
  c7_x_x = c7_h_A;
  c7_y_x = c7_x_x;
  c7_ab_x = c7_y_x;
  *c7_Tt_out = c7_ab_x / 2.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c7_sfEvent, -15);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, 18);
  *c7_Sfcn_out = c7_Sfcn_Ts(chartInstance, c7_f_Mix, *c7_Tt_out);
  _SFD_SCRIPT_CALL(0U, chartInstance->c7_sfEvent, -18);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  real_T c7_T, real_T c7_FuelAirRatio)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_FuelAirRatio, 7U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_Hi, 8U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c7_sfEvent, 6);
  if (CV_SCRIPT_IF(1, 0, CV_RELATIONAL_EVAL(14U, 1U, 0, c7_FuelAirRatio, 0.0, -1,
  ...
  if (CV_SCRIPT_IF(1, 1, CV_RELATIONAL_EVAL(14U, 1U, 1, c7_FuelAirRatio,
  ...
  if (CV_SCRIPT_IF(1, 2, CV_RELATIONAL_EVAL(14U, 1U, 2, c7_FuelAirRatio, 0.0, -1,
  ...
  if (CV_SCRIPT_IF(1, 3, CV_RELATIONAL_EVAL(14U, 1U, 3, c7_TE, 300.0, -1, 2U,
        c7_TE < 300.0))) {
  ...
  if (CV_SCRIPT_IF(1, 4, CV_RELATIONAL_EVAL(14U, 1U, 4, c7_TE, 4000.0, -1, 4U,
        c7_TE > 4000.0))) {
  ...
  *chartInstance, real_T c7_f, real_T c7_T)
{
  ...
  real_T c7_c_y;
  real_T c7_d_y;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 10U, c7_d_debug_family_names,
    c7_debug_family_var_map);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  chartInstance = (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c7_b_Sfcn45, const char_T *c7_identifier)
{
  ...
  c7_y = c7_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_b_Sfcn45),
    &c7_thisId);
  sf_mex_destroy(&c7_b_Sfcn45);
  return c7_y;
}
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  chartInstance = (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  c7_b_Sfcn45 = sf_mex_dup(c7_mxArrayInData);
...
const mxArray *sf_c7_GTF_EnginePath_TwoSpool_get_eml_resolved_functions_info
  (void)
{
  const mxArray *c7_nameCaptureInfo = NULL;
  c7_nameCaptureInfo = NULL;
  sf_mex_assign(&c7_nameCaptureInfo, sf_mex_createstruct("structure", 2, 115, 1),
                false);
...
static void c7_info_helper(const mxArray **c7_info)
{
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("CoolingCal_NGV"), "name",
                  "name", 7);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_NGV.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(1455934229U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_NGV.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("mrdivide"), "name", "name", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_NGV.m"), "context",
                  "context", 9);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("gashi"), "name", "name", 9);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_NGV.m"), "context",
                  "context", 11);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("Tt_h"), "name", "name", 11);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/Tt_h.m"), "resolved", "resolved", 11);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(1455934324U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c7_info, c7_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("mrdivide"), "name", "name", 12);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("gashi"), "name", "name", 13);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_NGV.m"), "context",
                  "context", 17);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("Sfcn_Ts"), "name", "name", 17);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("colon"), "name", "name", 18);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 20);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isfinite"), "name", "name", 20);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isinf"), "name", "name", 22);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 24);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isnan"), "name", "name", 24);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 26);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("floor"), "name", "name", 26);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkFlintRange"),
                  "context", "context", 31);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("flintmax"), "name", "name", 31);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 34);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("realmax"), "name", "name", 34);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon"),
                  "context", "context", 37);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("mrdivide"), "name", "name", 37);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon"),
                  "context", "context", 40);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmax"), "name", "name", 40);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("interp1"), "name", "name", 42);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 47);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("length"), "name", "name", 47);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 48);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("max"), "name", "name", 48);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 56);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("strncmpi"), "name", "name", 56);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 56);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_charmax.m"), "context",
                  "context", 59);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmax"), "name", "name", 59);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 59);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 60);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("min"), "name", "name", 60);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 60);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 62);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("lower"), "name", "name", 62);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 62);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
...
static void c7_b_info_helper(const mxArray **c7_info)
{
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 67);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("colon"), "name", "name", 67);
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 68);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("colon"), "name", "name", 68);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 70);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("floor"), "name", "name", 70);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 71);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmin"), "name", "name", 71);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 74);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmin"), "name", "name", 74);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 87);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isfi"), "name", "name", 87);
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 90);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmin"), "name", "name", 90);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 90);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 91);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "name", "name", 91);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 91);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 95);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isnan"), "name", "name", 95);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 95);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 97);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("isnan"), "name", "name", 97);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 97);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 101);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("floor"), "name", "name", 101);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 101);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 103);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmax"), "name", "name", 103);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 103);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 105);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("flip"), "name", "name", 105);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 105);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 110);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("floor"), "name", "name", 110);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 110);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 111);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("intmax"), "name", "name", 111);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 111);
  sf_mex_addfield(*c7_info, c7_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_GTF_EnginePath_TwoSpool), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_GTF_EnginePath_TwoSpool);
  return c7_y;
}
...
static void init_simulink_io_address(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance)
{
  chartInstance->c7_Tt44 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c7_W44 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c7_WcoolLPT = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c7_Tt_Z3 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c7_Tt45 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c7_Wf = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    4);
  chartInstance->c7_Sfcn45 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c7_GTF_EnginePath_TwoSpool_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(964708175U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2153470259U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1756067931U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1443606420U);
}

mxArray* sf_c7_GTF_EnginePath_TwoSpool_get_post_codegen_info(void);
mxArray *sf_c7_GTF_EnginePath_TwoSpool_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("PQPrrFnXV3h60zVLdfp0qE");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c7_GTF_EnginePath_TwoSpool_get_post_codegen_info();
...
mxArray *sf_c7_GTF_EnginePath_TwoSpool_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_GTF_EnginePath_TwoSpool_jit_fallback_info(void)
{
...
mxArray *sf_c7_GTF_EnginePath_TwoSpool_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_GTF_EnginePath_TwoSpool(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[10],T\"Sfcn45\",},{M[1],M[5],T\"Tt45\",},{M[8],M[0],T\"is_active_c7_GTF_EnginePath_TwoSpool\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_GTF_EnginePath_TwoSpool_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"Tt44");
          _SFD_SET_DATA_PROPS(1,1,1,0,"W44");
          _SFD_SET_DATA_PROPS(2,1,1,0,"WcoolLPT");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Tt_Z3");
          _SFD_SET_DATA_PROPS(4,2,0,1,"Tt45");
          _SFD_SET_DATA_PROPS(5,1,1,0,"Wf");
          _SFD_SET_DATA_PROPS(6,2,0,1,"Sfcn45");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(6,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c7_sf_marshallOut,(MexInFcnForType)c7_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c7_Tt44);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c7_W44);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c7_WcoolLPT);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c7_Tt_Z3);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c7_Tt45);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c7_Wf);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c7_Sfcn45);
      }
    } else {
...
{
  return "4y9hIxj2wzQm53t7KN8VkE";
}

static void sf_opaque_initialize_c7_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
  initialize_c7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  enable_c7_GTF_EnginePath_TwoSpool((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  disable_c7_GTF_EnginePath_TwoSpool((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  sf_gateway_c7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_GTF_EnginePath_TwoSpool
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_GTF_EnginePath_TwoSpool(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_GTF_EnginePath_TwoSpool
      ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_GTF_EnginePath_TwoSpool
    ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_GTF_EnginePath_TwoSpool
      ((SFc7_GTF_EnginePath_TwoSpoolInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3721541063U));
  ssSetChecksum1(S,(528932037U));
  ssSetChecksum2(S,(3475200980U));
  ssSetChecksum3(S,(3752378657U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c7_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct *)utMalloc(sizeof
    (SFc7_GTF_EnginePath_TwoSpoolInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_GTF_EnginePath_TwoSpoolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_GTF_EnginePath_TwoSpool;
...
void c7_GTF_EnginePath_TwoSpool_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_GTF_EnginePath_TwoSpool(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_GTF_EnginePath_TwoSpool_method_dispatcher.\n"
