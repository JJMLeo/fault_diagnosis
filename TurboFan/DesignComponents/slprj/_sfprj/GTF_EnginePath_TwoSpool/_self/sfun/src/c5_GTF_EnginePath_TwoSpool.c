...
static const char * c5_debug_family_names[31] = { "d_Sigma_BP", "A_BP", "f",
  "SigmaBP", "h_out", "Cpg", "kg", "Rg", "PR_cr", "PR_use", "hs_outCal", "error",
  "a", "b", "hs_outGuess", "Z", "Ts_out", "K_BP", "q", "nargin", "nargout",
  "Pt13", "Tt13", "Pamb", "Pt18", "Tt18", "W18", "V", "Ma", "PR_Real", "P18" };

static const char * c5_b_debug_family_names[9] = { "b_FuelAirRatio", "TE", "Hia",
  "Hif", "nargin", "nargout", "T", "FuelAirRatio", "Hi" };

static const char * c5_c_debug_family_names[7] = { "Cp_p", "SitaCp_p", "nargin",
  "nargout", "Ts", "f", "Cp" };

static const char * c5_d_debug_family_names[4] = { "nargin", "nargout", "f", "R"
};

static const char * c5_e_debug_family_names[5] = { "nargin", "nargout", "Ts",
  "f", "k" };

/* Function Declarations */
static void initialize_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initialize_params_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void enable_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void disable_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void set_sim_state_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void sf_gateway_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void mdl_start_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c5_chartstep_c5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initSimStructsc5_GTF_EnginePath_TwoSpool
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static real_T c5_gashi(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
  real_T c5_T, real_T c5_FuelAirRatio);
static real_T c5_Cp(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                    real_T c5_Ts, real_T c5_f);
static real_T c5_k(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                   real_T c5_Ts, real_T c5_f);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, const mxArray *c5_b_P18, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
...
static real_T c5_mpower(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c5_a, real_T c5_b);
static void c5_eml_scalar_eg(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c5_eml_error(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c5_sqrt(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                      real_T c5_x);
static void c5_b_eml_error(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c5_abs(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                     real_T c5_x);
static real_T c5_b_mpower(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c5_a);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c5_b_is_active_c5_GTF_EnginePath_TwoSpool, const
  char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sqrt(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                      real_T *c5_x);
static void init_dsm_address_info(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance);
  ...
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_GTF_EnginePath_TwoSpool = 0U;
}
   ...
   *c5_st)
{
  ...
  *chartInstance->c5_Ma = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 0)), "Ma");
  *chartInstance->c5_P18 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 1)), "P18");
  *chartInstance->c5_PR_Real = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 2)), "PR_Real");
  *chartInstance->c5_Pt18 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 3)), "Pt18");
  *chartInstance->c5_Tt18 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 4)), "Tt18");
  *chartInstance->c5_V = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 5)), "V");
  *chartInstance->c5_W18 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 6)), "W18");
  chartInstance->c5_is_active_c5_GTF_EnginePath_TwoSpool = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 7)),
     "is_active_c5_GTF_EnginePath_TwoSpool");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_GTF_EnginePath_TwoSpool(chartInstance);
  ...
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_GTF_EnginePath_TwoSpool(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_GTF_EnginePath_TwoSpoolMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Pt18, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Tt18, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Pt13, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Tt13, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_W18, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_V, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Ma, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_PR_Real, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_Pamb, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_P18, 9U);
}
  ...
  (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  real_T c5_b_Tt13;
  real_T c5_b_Pamb;
  uint32_T c5_debug_family_var_map[31];
  real_T c5_d_Sigma_BP;
  real_T c5_A_BP;
  real_T c5_f;
  real_T c5_SigmaBP;
  real_T c5_h_out;
  ...
  real_T c5_a;
  real_T c5_b;
  real_T c5_hs_outGuess;
  real_T c5_Z;
  real_T c5_Ts_out;
  real_T c5_K_BP;
  real_T c5_q;
  real_T c5_nargin = 3.0;
  real_T c5_nargout = 7.0;
  real_T c5_b_Pt18;
  real_T c5_b_Tt18;
  real_T c5_b_W18;
  real_T c5_b_V;
  ...
  c5_hoistedGlobal = *chartInstance->c5_Pt13;
  c5_b_hoistedGlobal = *chartInstance->c5_Tt13;
  c5_c_hoistedGlobal = *chartInstance->c5_Pamb;
  c5_b_Pt13 = c5_hoistedGlobal;
  c5_b_Tt13 = c5_b_hoistedGlobal;
  c5_b_Pamb = c5_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 31U, 31U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_d_Sigma_BP, 0U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_A_BP, 1U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_f, 2U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_SigmaBP, 3U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_h_out, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Cpg, 5U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_kg, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_Rg, 7U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_PR_cr, 8U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_PR_use, 9U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_hs_outCal, 10U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_error, 11U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_a, 12U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b, 13U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_hs_outGuess, 14U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Z, 15U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Ts_out, 16U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_K_BP, 17U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q, 18U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargin, 19U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 20U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_Pt13, 21U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_Tt13, 22U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_Pamb, 23U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_Pt18, 24U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_Tt18, 25U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_W18, 26U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_V, 27U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_Ma, 28U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_PR_Real, 29U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_P18, 30U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 3);
  c5_d_Sigma_BP = 0.975;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 4);
  c5_A_BP = 1.345352398639565;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 7);
  c5_f = 0.0;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 10);
  c5_SigmaBP = 0.975;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 11);
  c5_b_Pt18 = c5_b_Pt13 * 0.975;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 12);
  c5_b_Tt18 = c5_b_Tt13;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 13);
  c5_h_out = c5_gashi(chartInstance, c5_b_Tt13, 0.0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 16);
  c5_Cpg = c5_Cp(chartInstance, c5_b_Tt18, 0.0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 17);
  c5_kg = c5_k(chartInstance, c5_b_Tt18, 0.0);
  ...
  c5_PR_cr = c5_mpower(chartInstance, c5_y, c5_e_y);
  ...
  c5_i_x = c5_h_x;
  c5_h_y = c5_g_y;
  c5_PR_use = c5_i_x / c5_h_y;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 27);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c5_PR_use, c5_PR_cr, -1,
        2U, c5_PR_use < c5_PR_cr))) {
    ...
    c5_o_x = c5_n_x;
    c5_n_y = c5_m_y;
    c5_o_y = c5_o_x / c5_n_y;
    c5_d0 = 2.0 * c5_Cpg * c5_b_Tt18 * (1.0 - c5_mpower(chartInstance,
      c5_b_PR_Real, c5_o_y));
    c5_b_sqrt(chartInstance, &c5_d0);
    c5_b_V = c5_d0;
    _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 32);
    c5_hs_outCal = c5_h_out - 0.5 * c5_b_V * c5_b_V * 0.001;
    ...
    while (CV_EML_WHILE(0, 1, 0, c5_error >= 1.0E-9)) {
      ...
      c5_r_x = c5_q_x;
      c5_p_y = c5_r_x / 2.0;
      c5_hs_outGuess = c5_gashi(chartInstance, c5_p_y, 0.0);
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 38);
      c5_Z = c5_hs_outGuess - c5_hs_outCal;
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 39);
      c5_g_A = c5_hs_outGuess - c5_hs_outCal;
      c5_e_B = c5_hs_outCal;
      c5_s_x = c5_g_A;
      c5_q_y = c5_e_B;
      c5_t_x = c5_s_x;
      ...
      c5_u_x = c5_t_x;
      c5_s_y = c5_r_y;
      c5_t_y = c5_u_x / c5_s_y;
      c5_error = c5_abs(chartInstance, c5_t_y);
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 40);
      if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c5_Z, 0.0, -1, 4U,
            c5_Z > 0.0))) {
    ...
    c5_db_x = c5_cb_x;
    c5_eb_x = c5_db_x;
    c5_Ts_out = c5_eb_x / 2.0;
    _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 47);
    c5_k_A = c5_b_V;
    c5_f_B = c5_kg * 287.5 * c5_Ts_out;
    c5_b_sqrt(chartInstance, &c5_f_B);
    c5_fb_x = c5_k_A;
    c5_u_y = c5_f_B;
    c5_gb_x = c5_fb_x;
    c5_v_y = c5_u_y;
    ...
    c5_qb_x = c5_pb_x;
    c5_gb_y = c5_fb_y;
    c5_hb_y = c5_qb_x / c5_gb_y;
    c5_rb_x = 2.0 * c5_Cpg * c5_b_Tt18 * (1.0 - c5_mpower(chartInstance,
      c5_b_PR_Real, c5_hb_y));
    c5_b_V = c5_rb_x;
    if (c5_b_V < 0.0) {
  ...
  c5_cc_x = c5_bc_x;
  c5_sb_y = c5_rb_y;
  c5_tb_y = c5_cc_x / c5_sb_y;
  c5_dc_x = c5_lb_y * c5_mpower(chartInstance, c5_pb_y, c5_tb_y);
  c5_K_BP = c5_dc_x;
  if (c5_K_BP < 0.0) {
    c5_b_eml_error(chartInstance);
  }
  ...
  c5_ec_x = c5_K_BP;
  c5_K_BP = c5_ec_x;
  c5_K_BP = muDoubleScalarSqrt(c5_K_BP);
  ...
  c5_hc_x = c5_gc_x;
  c5_bc_y = c5_ac_y;
  c5_cc_y = c5_hc_x / c5_bc_y;
  c5_q = c5_b_Ma * c5_mpower(chartInstance, c5_xb_y * (1.0 + 0.5 * (c5_kg - 1.0)
    * c5_b_mpower(chartInstance, c5_b_Ma)), c5_cc_y);
  ...
  c5_jc_x = muDoubleScalarSqrt(c5_jc_x);
  c5_s_A = c5_K_BP * 1.345352398639565 * c5_q * c5_b_Pt18;
  c5_o_B = c5_jc_x;
  c5_kc_x = c5_s_A;
  c5_dc_y = c5_o_B;
  c5_lc_x = c5_kc_x;
  ...
  c5_mc_x = c5_lc_x;
  c5_fc_y = c5_ec_y;
  c5_b_W18 = c5_mc_x / c5_fc_y;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -64);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c5_Pt18 = c5_b_Pt18;
  *chartInstance->c5_Tt18 = c5_b_Tt18;
  *chartInstance->c5_W18 = c5_b_W18;
  *chartInstance->c5_V = c5_b_V;
  *chartInstance->c5_Ma = c5_b_Ma;
  *chartInstance->c5_PR_Real = c5_b_PR_Real;
  *chartInstance->c5_P18 = c5_b_P18;
  ...
  real_T c5_T, real_T c5_FuelAirRatio)
{
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c5_b_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_FuelAirRatio, 0U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_TE, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Hia, 2U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Hif, 3U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 5U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_T, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_FuelAirRatio, 7U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Hi, 8U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 6);
  if (CV_SCRIPT_IF(0, 0, CV_RELATIONAL_EVAL(14U, 0U, 0, c5_FuelAirRatio, 0.0, -1,
        2U, c5_FuelAirRatio < 0.0))) {
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 7);
    c5_FuelAirRatio = 0.0;
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 10);
  if (CV_SCRIPT_IF(0, 1, CV_RELATIONAL_EVAL(14U, 0U, 1, c5_FuelAirRatio,
        0.067623, -1, 4U, c5_FuelAirRatio > 0.067623))) {
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 11);
    c5_FuelAirRatio = 0.067623;
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 14);
  c5_b_FuelAirRatio = 0.0;
  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 16);
  if (CV_SCRIPT_IF(0, 2, CV_RELATIONAL_EVAL(14U, 0U, 2, c5_FuelAirRatio, 0.0, -1,
        0U, c5_FuelAirRatio == 0.0))) {
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 17);
    c5_b_FuelAirRatio = 1.0;
  }
  ...
  if (CV_SCRIPT_IF(0, 3, CV_RELATIONAL_EVAL(14U, 0U, 3, c5_TE, 300.0, -1, 2U,
        c5_TE < 300.0))) {
  ...
  if (CV_SCRIPT_IF(0, 4, CV_RELATIONAL_EVAL(14U, 0U, 4, c5_TE, 4000.0, -1, 4U,
        c5_TE > 4000.0))) {
  ...
  c5_Hia = (((((((1.2644425E-26 * c5_TE - 2.0752522E-22) * c5_TE + 1.270263E-18)
                * c5_TE - 3.0256518E-15) * c5_TE - 1.6794594E-12) * c5_TE +
              2.1839826E-8) * c5_TE - 2.576844E-5) * c5_TE + 0.25020051) * c5_TE
    - 1.7558886;
  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 33);
  switch ((int32_T)_SFD_INTEGER_CHECK("b_FuelAirRatio", c5_b_FuelAirRatio)) {
   case 1:
    CV_SCRIPT_SWITCH(0, 0, 1);
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 38);
    c5_Hi = c5_Hia * 2.3254259;
    break;

   default:
    CV_SCRIPT_SWITCH(0, 0, 0);
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 42);
    c5_Hif = (((((((9.0848388E-26 * c5_TE - 1.9050949E-21) * c5_TE +
                   1.7021525E-17) * c5_TE - 8.4102208E-14) * c5_TE +
                 2.4921698E-10) * c5_TE - 4.5906332E-7) * c5_TE + 0.0006129315) *
              c5_TE + 0.073816638) * c5_TE + 30.58153;
    _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, 43);
    c5_c_A = c5_Hia + c5_FuelAirRatio * c5_Hif;
    c5_B = 1.0 + c5_FuelAirRatio;
    c5_g_x = c5_c_A;
    c5_y = c5_B;
    c5_h_x = c5_g_x;
    c5_b_y = c5_y;
                    ...
                    real_T c5_Ts, real_T c5_f)
{
  ...
  real_T c5_Cp_p[9];
  real_T c5_SitaCp_p[8];
  real_T c5_nargin = 2.0;
  real_T c5_nargout = 1.0;
  int32_T c5_i0;
  static real_T c5_p[9] = { -0.081873, 0.797112, -3.234725, 7.097112, -8.893933,
    6.083152, -1.852148, 0.236688, 0.992313 };

  int32_T c5_i1;
  static real_T c5_b_p[8] = { -0.003919, -0.361112, 3.081778, -10.233795,
  ...
  int32_T c5_b_k;
  real_T c5_c_k;
  static real_T c5_dv0[9] = { -0.081873, 0.797112, -3.234725, 7.097112,
  ...
  int32_T c5_d_k;
  real_T c5_e_k;
  static real_T c5_dv1[8] = { -0.003919, -0.361112, 3.081778, -10.233795,
    17.254096, -15.863157, 8.347481, -0.718874 };

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c5_c_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_Cp_p, 0U, c5_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_SitaCp_p, 1U, c5_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 3U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Ts, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_f, 5U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_Cp, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c5_sfEvent, 2);
  for (c5_i0 = 0; c5_i0 < 9; c5_i0++) {
    c5_Cp_p[c5_i0] = c5_p[c5_i0];
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c5_sfEvent, 3);
  for (c5_i1 = 0; c5_i1 < 8; c5_i1++) {
    c5_SitaCp_p[c5_i1] = c5_b_p[c5_i1];
  }
  ...
  for (c5_b_k = 0; c5_b_k < 8; c5_b_k++) {
    c5_c_k = 2.0 + (real_T)c5_b_k;
    c5_b_y = c5_d_x * c5_b_y + c5_dv0[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c5_c_k), 1, 9, 1, 0) - 1];
  }
  ...
  c5_g_x = c5_f_x;
  c5_e_y = c5_d_y;
  c5_f_y = c5_g_x / c5_e_y;
  c5_c_A = c5_Ts;
  c5_h_x = c5_c_A;
  c5_i_x = c5_h_x;
  c5_j_x = c5_i_x;
  c5_g_y = c5_j_x / 1000.0;
  c5_k_x = c5_g_y;
  c5_h_y = -0.003919;
  for (c5_d_k = 0; c5_d_k < 7; c5_d_k++) {
    c5_e_k = 2.0 + (real_T)c5_d_k;
    c5_h_y = c5_k_x * c5_h_y + c5_dv1[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c5_e_k), 1, 8, 1, 0) - 1];
  }

  c5_b_Cp = (c5_b_y + c5_f_y * c5_h_y) * 1000.0;
  _SFD_SCRIPT_CALL(1U, chartInstance->c5_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  return c5_b_Cp;
}
                   ...
                   real_T c5_Ts, real_T c5_f)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_Ts, 2U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_f, 3U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_k, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  _SFD_SCRIPT_CALL(2U, chartInstance->c5_sfEvent, 2);
  c5_b_f = c5_f;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_f, 2U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_R, 3U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_SCRIPT_FCN(3, 0);
  _SFD_SCRIPT_CALL(3U, chartInstance->c5_sfEvent, 2);
  c5_R = (287.5 - 0.0099 * c5_b_f) + c5_b_f * 1.0E-7;
  _SFD_SCRIPT_CALL(3U, chartInstance->c5_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  c5_A = c5_Cp(chartInstance, c5_Ts, c5_f);
  c5_B = c5_Cp(chartInstance, c5_Ts, c5_f) - c5_R;
  c5_x = c5_A;
  c5_y = c5_B;
  c5_b_x = c5_x;
  c5_b_y = c5_y;
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  chartInstance = (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c5_b_P18, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_P18), &c5_thisId);
  sf_mex_destroy(&c5_b_P18);
  return c5_y;
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  chartInstance = (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  c5_b_P18 = sf_mex_dup(c5_mxArrayInData);
  ...
  *c5_inData)
{
  ...
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_create("y", c5_u, 0, 0U, 1U, 0U, 2, 1, 8), false);
  sf_mex_assign(&c5_mxArrayOutData, c5_y, false);
  return c5_mxArrayOutData;
}
  ...
  *c5_inData)
{
  ...
  for (c5_i4 = 0; c5_i4 < 9; c5_i4++) {
    c5_b_inData[c5_i4] = (*(real_T (*)[9])c5_inData)[c5_i4];
  }
...
const mxArray *sf_c5_GTF_EnginePath_TwoSpool_get_eml_resolved_functions_info
  (void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 38, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("gashi"), "name", "name", 0);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/gashi.m"), "resolved", "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1428734872U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("Cp"), "name", "name", 8);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/Cp.m"), "resolved", "resolved", 8);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1430030153U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/Cp.m"), "context", "context", 10);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("polyval"), "name", "name", 10);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/polyval.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1305296402U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("k"), "name", "name", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/k.m"), "resolved", "resolved", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1430018432U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs13), "lhs", "lhs",
                  13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/k.m"), "context", "context", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("Cp"), "name", "name", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/Cp.m"), "resolved", "resolved", 14);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1430030153U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs14), "lhs", "lhs",
                  14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/k.m"), "context", "context", 15);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("R"), "name", "name", 15);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/R.m"), "resolved", "resolved", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1432376608U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs15), "lhs", "lhs",
                  15);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/k.m"), "context", "context", 16);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("R"), "name", "name", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/R.m"), "resolved", "resolved", 17);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1432376608U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mpower"), "name", "name", 19);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 21);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("ismatrix"), "name", "name", 21);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("power"), "name", "name", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1395303306U), "fileTimeLo",
                  "fileTimeLo", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 22);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("floor"), "name", "name", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sqrt"), "name", "name", 32);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 35);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  *chartInstance, real_T c5_a, real_T c5_b)
{
  ...
  c5_ar = c5_d_a;
  c5_br = c5_d_b;
  return muDoubleScalarPower(c5_ar, c5_br);
}
  ...
  *chartInstance)
{
  ...
  const mxArray *c5_y = NULL;
  (void)chartInstance;
  for (c5_i6 = 0; c5_i6 < 31; c5_i6++) {
    c5_u[c5_i6] = c5_cv0[c5_i6];
  }
  ...
  char_T *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_GTF_EnginePath_TwoSpool), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_GTF_EnginePath_TwoSpool);
  return c5_y;
}
...
static void init_simulink_io_address(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance)
{
  chartInstance->c5_Pt18 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_Tt18 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c5_Pt13 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c5_Tt13 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_W18 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c5_V = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    4);
  chartInstance->c5_Ma = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c5_PR_Real = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 6);
  chartInstance->c5_Pamb = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c5_P18 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 7);
}
...
void sf_c5_GTF_EnginePath_TwoSpool_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1216930080U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2910308112U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1395344498U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3976163405U);
}

mxArray* sf_c5_GTF_EnginePath_TwoSpool_get_post_codegen_info(void);
mxArray *sf_c5_GTF_EnginePath_TwoSpool_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("A6DBJ7aBqjGTcKQ6s2AqeD");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c5_GTF_EnginePath_TwoSpool_get_post_codegen_info();
...
mxArray *sf_c5_GTF_EnginePath_TwoSpool_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_GTF_EnginePath_TwoSpool_jit_fallback_info(void)
{
...
mxArray *sf_c5_GTF_EnginePath_TwoSpool_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_GTF_EnginePath_TwoSpool(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[14],T\"Ma\",},{M[1],M[11],T\"P18\",},{M[1],M[15],T\"PR_Real\",},{M[1],M[12],T\"Pt18\",},{M[1],M[16],T\"Tt18\",},{M[1],M[13],T\"V\",},{M[1],M[5],T\"W18\",},{M[8],M[0],T\"is_active_c5_GTF_EnginePath_TwoSpool\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_GTF_EnginePath_TwoSpool_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"Pt18");
          _SFD_SET_DATA_PROPS(1,2,0,1,"Tt18");
          _SFD_SET_DATA_PROPS(2,1,1,0,"Pt13");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Tt13");
          _SFD_SET_DATA_PROPS(4,2,0,1,"W18");
          _SFD_SET_DATA_PROPS(5,2,0,1,"V");
          _SFD_SET_DATA_PROPS(6,2,0,1,"Ma");
          _SFD_SET_DATA_PROPS(7,2,0,1,"PR_Real");
          _SFD_SET_DATA_PROPS(8,1,1,0,"Pamb");
          _SFD_SET_DATA_PROPS(9,2,0,1,"P18");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,395,410,875,1031);
        _SFD_CV_INIT_EML_IF(0,1,1,740,746,778,817);
        _SFD_CV_INIT_EML_WHILE(0,1,0,589,607,825);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,398,410,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,743,746,-1,4);
        ...
        _SFD_CV_INIT_SCRIPT_FCN(2,0,"k",0,-1,46);
        _SFD_CV_INIT_SCRIPT(3,1,0,0,0,0,0,0,0,0);
        _SFD_CV_INIT_SCRIPT_FCN(3,0,"R",0,-1,40);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(9,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c5_sf_marshallOut,(MexInFcnForType)c5_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c5_Pt18);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c5_Tt18);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c5_Pt13);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c5_Tt13);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c5_W18);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c5_V);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c5_Ma);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c5_PR_Real);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c5_Pamb);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c5_P18);
      }
    } else {
...
{
  return "BMpZ6dlflB2UoXEt6xzzWE";
}

static void sf_opaque_initialize_c5_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
  initialize_c5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  enable_c5_GTF_EnginePath_TwoSpool((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  disable_c5_GTF_EnginePath_TwoSpool((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  sf_gateway_c5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_GTF_EnginePath_TwoSpool
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_GTF_EnginePath_TwoSpool(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_GTF_EnginePath_TwoSpool
      ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_GTF_EnginePath_TwoSpool
    ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_GTF_EnginePath_TwoSpool
      ((SFc5_GTF_EnginePath_TwoSpoolInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3851973673U));
  ssSetChecksum1(S,(983433050U));
  ssSetChecksum2(S,(1121835861U));
  ssSetChecksum3(S,(3616717547U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct *)utMalloc(sizeof
    (SFc5_GTF_EnginePath_TwoSpoolInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_GTF_EnginePath_TwoSpoolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_GTF_EnginePath_TwoSpool;
...
void c5_GTF_EnginePath_TwoSpool_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_GTF_EnginePath_TwoSpool(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_GTF_EnginePath_TwoSpool_method_dispatcher.\n"
