...
static const char * c3_debug_family_names[9] = { "f", "nargin", "nargout", "PR",
  "Eff", "Tt2", "h3", "h2", "Tt3" };

static const char * c3_b_debug_family_names[18] = { "amw", "R_eng",
  "b_FuelAirRatio", "Cpcal", "TO", "T", "TE", "Cpa", "Cpf", "nargin", "nargout",
  "TI", "FAR", "PRK", "Eff", "Cp", "k", "R" };

static const char * c3_c_debug_family_names[8] = { "kg", "nargin", "nargout",
  "Tt_in", "f", "ComprPR", "ComprEff", "Tt_out" };

static const char * c3_d_debug_family_names[9] = { "b_FuelAirRatio", "TE", "Hia",
  "Hif", "nargin", "nargout", "T", "FuelAirRatio", "Hi" };

/* Function Declarations */
static void initialize_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initialize_params_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void enable_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void disable_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void set_sim_state_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void sf_gateway_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void mdl_start_c3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initSimStructsc3_GTF_EnginePath_TwoSpool
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c3_gasstate(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c3_TI, real_T c3_FAR, real_T c3_PRK, real_T c3_b_Eff,
  real_T *c3_Cp, real_T *c3_k, real_T *c3_R);
static real_T c3_gashi(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
  real_T c3_T, real_T c3_FuelAirRatio);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, const mxArray *c3_b_Tt3, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
...
static real_T c3_mpower(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c3_a, real_T c3_b);
static void c3_eml_scalar_eg(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c3_eml_error(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c3_b_is_active_c3_GTF_EnginePath_TwoSpool, const
  char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance);
  ...
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_GTF_EnginePath_TwoSpool = 0U;
}
  ...
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = *chartInstance->c3_Tt3;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = *chartInstance->c3_h2;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = *chartInstance->c3_h3;
  c3_c_u = c3_c_hoistedGlobal;
  c3_d_y = NULL;
  sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 2, c3_d_y);
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_GTF_EnginePath_TwoSpool;
   ...
   *c3_st)
{
  ...
  *chartInstance->c3_Tt3 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "Tt3");
  *chartInstance->c3_h2 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "h2");
  *chartInstance->c3_h3 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 2)), "h3");
  chartInstance->c3_is_active_c3_GTF_EnginePath_TwoSpool = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_GTF_EnginePath_TwoSpool");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_GTF_EnginePath_TwoSpool(chartInstance);
  ...
  (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = *chartInstance->c3_PR;
  c3_b_hoistedGlobal = *chartInstance->c3_Eff;
  c3_c_hoistedGlobal = *chartInstance->c3_Tt2;
  c3_b_PR = c3_hoistedGlobal;
  c3_b_Eff = c3_b_hoistedGlobal;
  c3_b_Tt2 = c3_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_f, 0U, c3_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_PR, 3U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_Eff, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_Tt2, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_h3, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_h2, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_Tt3, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_b_f = 0.0;
  c3_ComprPR = c3_b_PR;
  c3_ComprEff = c3_b_Eff;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c3_c_debug_family_names,
    c3_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_kg, 0U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_nargout, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Tt_in, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_f, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_ComprPR, 5U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_ComprEff, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_Tt3, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c3_sfEvent, 2);
  c3_gasstate(chartInstance, c3_Tt_in, c3_b_f, c3_ComprPR, c3_ComprEff,
              &c3_unusedU0, &c3_b_kg, &c3_unusedU1);
  c3_kg = c3_b_kg;
  _SFD_SCRIPT_CALL(0U, chartInstance->c3_sfEvent, 2);
  _SFD_SCRIPT_CALL(0U, chartInstance->c3_sfEvent, 2);
  ...
  c3_b_A = c3_mpower(chartInstance, c3_ComprPR, c3_d_y) - 1.0;
  c3_b_B = c3_ComprEff;
  c3_d_x = c3_b_A;
  c3_e_y = c3_b_B;
  c3_e_x = c3_d_x;
  ...
  c3_b_Tt3 = (c3_h_y + 1.0) * c3_Tt_in;
  _SFD_SCRIPT_CALL(0U, chartInstance->c3_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 7);
  c3_b_h2 = c3_gashi(chartInstance, c3_b_Tt2, 0.0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
  c3_b_h3 = c3_gashi(chartInstance, c3_b_Tt3, 0.0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -9);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c3_h3 = c3_b_h3;
  *chartInstance->c3_h2 = c3_b_h2;
  *chartInstance->c3_Tt3 = c3_b_Tt3;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_GTF_EnginePath_TwoSpoolMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_h3, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_h2, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_PR, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Tt3, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Eff, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Tt2, 5U);
}
  ...
  real_T *c3_Cp, real_T *c3_k, real_T *c3_R)
{
  ...
  real_T c3_u_y;
  int32_T exitg1;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 18U, 18U, c3_b_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_amw, 0U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_R_eng, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_FuelAirRatio, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Cpcal, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_TO, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_T, 5U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_TE, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Cpa, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Cpf, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 10U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_TI, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_FAR, 12U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_PRK, 13U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_Eff, 14U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_Cp, 15U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_k, 16U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_R, 17U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 4);
  c3_amw = 28.97 - 0.946186 * c3_FAR;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 5);
  c3_B = c3_amw;
  c3_y = c3_B;
  c3_b_y = c3_y;
  c3_c_y = c3_b_y;
  c3_R_eng = 1.986375 / c3_c_y;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 6);
  *c3_R = c3_R_eng * 4185.7666;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 8);
  if (CV_SCRIPT_IF(1, 0, CV_RELATIONAL_EVAL(14U, 1U, 0, c3_FAR, 0.0, -1, 2U,
        c3_FAR < 0.0))) {
  ...
  if (CV_SCRIPT_IF(1, 1, CV_RELATIONAL_EVAL(14U, 1U, 1, c3_FAR, 0.067623, -1, 4U,
        c3_FAR > 0.067623))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 12);
    c3_FAR = 0.067623;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 15);
  c3_b_FuelAirRatio = 0.0;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 16);
  if (CV_SCRIPT_IF(1, 2, CV_RELATIONAL_EVAL(14U, 1U, 2, c3_FAR, 0.0, -1, 0U,
        c3_FAR == 0.0))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 17);
    c3_b_FuelAirRatio = 1.0;
  }
  ...
  *c3_Cp = 1100.0;
  ...
  c3_Cpcal = 1200.0;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 23);
  do {
    exitg1 = 0;
    c3_x = *c3_Cp - c3_Cpcal;
    c3_b_x = c3_x;
    c3_d_y = muDoubleScalarAbs(c3_b_x);
    if (CV_SCRIPT_WHILE(1, 0, c3_d_y - 1.0E-7 * c3_Cpcal > 0.0)) {
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 24);
      *c3_Cp = c3_Cpcal;
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 25);
      c3_A = *c3_Cp;
      c3_b_B = *c3_Cp - *c3_R;
      c3_c_x = c3_A;
      c3_e_y = c3_b_B;
      ...
      *c3_k = c3_e_x / c3_g_y;
      ...
      c3_h_x = c3_g_x;
      c3_j_y = c3_i_y;
      c3_k_y = c3_h_x / c3_j_y;
      c3_c_A = c3_mpower(chartInstance, c3_PRK, c3_k_y) - 1.0;
      c3_d_B = c3_b_Eff;
      c3_i_x = c3_c_A;
      c3_l_y = c3_d_B;
      c3_j_x = c3_i_x;
      ...
      c3_k_x = c3_j_x;
      c3_n_y = c3_m_y;
      c3_o_y = c3_k_x / c3_n_y;
      c3_TO = c3_TI * (1.0 + c3_o_y);
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 27);
      c3_d_A = c3_TI + c3_TO;
      c3_l_x = c3_d_A;
      c3_m_x = c3_l_x;
      c3_n_x = c3_m_x;
      c3_T = c3_n_x / 2.0;
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 29);
      c3_e_A = c3_T * 9.0;
      c3_o_x = c3_e_A;
      c3_p_x = c3_o_x;
      c3_q_x = c3_p_x;
      c3_TE = c3_q_x / 5.0;
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 30);
      if (CV_SCRIPT_IF(1, 3, CV_RELATIONAL_EVAL(14U, 1U, 3, c3_TE, 300.0, -1, 2U,
            c3_TE < 300.0))) {
      ...
      if (CV_SCRIPT_IF(1, 4, CV_RELATIONAL_EVAL(14U, 1U, 4, c3_TE, 4000.0, -1,
            4U, c3_TE > 4000.0))) {
      ...
      c3_Cpa = ((((((1.011554E-25 * c3_TE - 1.452677E-21) * c3_TE +
                    7.6215767E-18) * c3_TE - 1.5128259E-14) * c3_TE -
                  6.7178376E-12) * c3_TE + 6.5519486E-8) * c3_TE - 5.1536879E-5)
        * c3_TE + 0.25020051;
      _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 40);
      switch ((int32_T)_SFD_INTEGER_CHECK("b_FuelAirRatio", c3_b_FuelAirRatio))
      {
       case 1:
        CV_SCRIPT_SWITCH(1, 0, 1);
        _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 44);
        c3_Cpcal = c3_Cpa * 4185.7666;
        break;

       default:
        CV_SCRIPT_SWITCH(1, 0, 0);
        _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 47);
        c3_Cpf = ((((((7.267871E-25 * c3_TE - 1.3335668E-20) * c3_TE +
                      1.0212913E-16) * c3_TE - 4.2051104E-13) * c3_TE +
                    9.9686793E-10) * c3_TE - 1.3771901E-6) * c3_TE + 0.001225863)
          * c3_TE + 0.073816638;
        _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 48);
        c3_g_A = c3_Cpa + c3_FAR * c3_Cpf;
        c3_f_B = 1.0 + c3_FAR;
        c3_u_x = c3_g_A;
        c3_s_y = c3_f_B;
        c3_v_x = c3_u_x;
        ...
        c3_w_x = c3_v_x;
        c3_u_y = c3_t_y;
        c3_Cpf = c3_w_x / c3_u_y;
        _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 51);
        c3_Cpcal = c3_Cpf * 4185.7666;
        break;
      }
  ...
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 57);
  c3_f_A = *c3_Cp;
  c3_e_B = *c3_Cp - *c3_R;
  c3_r_x = c3_f_A;
  c3_p_y = c3_e_B;
  ...
  c3_r_y = c3_q_y;
  *c3_k = c3_t_x / c3_r_y;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, 59);
  *c3_Cp = c3_Cpcal;
  _SFD_SCRIPT_CALL(1U, chartInstance->c3_sfEvent, -59);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  real_T c3_T, real_T c3_FuelAirRatio)
{
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c3_d_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_FuelAirRatio, 0U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_TE, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Hia, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Hif, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_T, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_FuelAirRatio, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Hi, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 6);
  if (CV_SCRIPT_IF(2, 0, CV_RELATIONAL_EVAL(14U, 2U, 0, c3_FuelAirRatio, 0.0, -1,
        2U, c3_FuelAirRatio < 0.0))) {
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 7);
    c3_FuelAirRatio = 0.0;
  }

  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 10);
  if (CV_SCRIPT_IF(2, 1, CV_RELATIONAL_EVAL(14U, 2U, 1, c3_FuelAirRatio,
        0.067623, -1, 4U, c3_FuelAirRatio > 0.067623))) {
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 11);
    c3_FuelAirRatio = 0.067623;
  }

  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 14);
  c3_b_FuelAirRatio = 0.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 16);
  if (CV_SCRIPT_IF(2, 2, CV_RELATIONAL_EVAL(14U, 2U, 2, c3_FuelAirRatio, 0.0, -1,
        0U, c3_FuelAirRatio == 0.0))) {
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 17);
    c3_b_FuelAirRatio = 1.0;
  }

  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 21);
  c3_A = c3_T * 9.0;
  c3_x = c3_A;
  c3_b_x = c3_x;
  c3_c_x = c3_b_x;
  c3_TE = c3_c_x / 5.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 22);
  if (CV_SCRIPT_IF(2, 3, CV_RELATIONAL_EVAL(14U, 2U, 3, c3_TE, 300.0, -1, 2U,
        c3_TE < 300.0))) {
  ...
  if (CV_SCRIPT_IF(2, 4, CV_RELATIONAL_EVAL(14U, 2U, 4, c3_TE, 4000.0, -1, 4U,
        c3_TE > 4000.0))) {
  ...
  c3_Hia = (((((((1.2644425E-26 * c3_TE - 2.0752522E-22) * c3_TE + 1.270263E-18)
                * c3_TE - 3.0256518E-15) * c3_TE - 1.6794594E-12) * c3_TE +
              2.1839826E-8) * c3_TE - 2.576844E-5) * c3_TE + 0.25020051) * c3_TE
    - 1.7558886;
  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 33);
  switch ((int32_T)_SFD_INTEGER_CHECK("b_FuelAirRatio", c3_b_FuelAirRatio)) {
   case 1:
    CV_SCRIPT_SWITCH(2, 0, 1);
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 38);
    c3_Hi = c3_Hia * 2.3254259;
    break;

   default:
    CV_SCRIPT_SWITCH(2, 0, 0);
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 42);
    c3_Hif = (((((((9.0848388E-26 * c3_TE - 1.9050949E-21) * c3_TE +
                   1.7021525E-17) * c3_TE - 8.4102208E-14) * c3_TE +
                 2.4921698E-10) * c3_TE - 4.5906332E-7) * c3_TE + 0.0006129315) *
              c3_TE + 0.073816638) * c3_TE + 30.58153;
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 43);
    c3_c_A = c3_Hia + c3_FuelAirRatio * c3_Hif;
    c3_B = 1.0 + c3_FuelAirRatio;
    c3_g_x = c3_c_A;
    c3_y = c3_B;
    c3_h_x = c3_g_x;
    c3_b_y = c3_y;
    c3_i_x = c3_h_x;
    c3_c_y = c3_b_y;
    c3_Hif = c3_i_x / c3_c_y;
    _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 46);
    c3_Hi = c3_Hif * 2.3254259;
    break;
  }

  _SFD_SCRIPT_CALL(2U, chartInstance->c3_sfEvent, 48);
  c3_b_A = c3_TE * 5.0;
  c3_d_x = c3_b_A;
  c3_e_x = c3_d_x;
  c3_f_x = c3_e_x;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  chartInstance = (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_b_Tt3, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_Tt3), &c3_thisId);
  sf_mex_destroy(&c3_b_Tt3);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  chartInstance = (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  c3_b_Tt3 = sf_mex_dup(c3_mxArrayInData);
...
const mxArray *sf_c3_GTF_EnginePath_TwoSpool_get_eml_resolved_functions_info
  (void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("GasTt"), "name", "name", 0);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/GasTt.m"), "resolved", "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1460024766U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("gasstate"), "name", "name", 1);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/gasstate.m"), "resolved", "resolved",
                  1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1460024745U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("gashi"), "name", "name", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/gashi.m"), "resolved", "resolved", 28);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1428734872U), "fileTimeLo",
                  "fileTimeLo", 28);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 28);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 29);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_GTF_EnginePath_TwoSpool), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_GTF_EnginePath_TwoSpool);
  return c3_y;
}
...
static void init_simulink_io_address(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance)
{
  chartInstance->c3_h3 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_h2 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_PR = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c3_Tt3 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c3_Eff = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_Tt2 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c3_GTF_EnginePath_TwoSpool_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4062338511U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(499984709U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(658265306U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2713518001U);
}

mxArray* sf_c3_GTF_EnginePath_TwoSpool_get_post_codegen_info(void);
mxArray *sf_c3_GTF_EnginePath_TwoSpool_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("M8bLvTMEG2z4hvz06eZVvG");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_GTF_EnginePath_TwoSpool_get_post_codegen_info();
...
mxArray *sf_c3_GTF_EnginePath_TwoSpool_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_GTF_EnginePath_TwoSpool_jit_fallback_info(void)
{
...
mxArray *sf_c3_GTF_EnginePath_TwoSpool_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_GTF_EnginePath_TwoSpool(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Tt3\",},{M[1],M[9],T\"h2\",},{M[1],M[8],T\"h3\",},{M[8],M[0],T\"is_active_c3_GTF_EnginePath_TwoSpool\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_GTF_EnginePath_TwoSpool_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"h3");
          _SFD_SET_DATA_PROPS(1,2,0,1,"h2");
          _SFD_SET_DATA_PROPS(2,1,1,0,"PR");
          _SFD_SET_DATA_PROPS(3,2,0,1,"Tt3");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(5,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c3_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c3_h3);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c3_h2);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c3_PR);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c3_Tt3);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c3_Eff);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c3_Tt2);
      }
    } else {
...
{
  return "hY6N5QwD64f0xYl9kmMQSB";
}

static void sf_opaque_initialize_c3_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
  initialize_c3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  enable_c3_GTF_EnginePath_TwoSpool((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  disable_c3_GTF_EnginePath_TwoSpool((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  sf_gateway_c3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_GTF_EnginePath_TwoSpool
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_GTF_EnginePath_TwoSpool(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_GTF_EnginePath_TwoSpool
      ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_GTF_EnginePath_TwoSpool
    ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_GTF_EnginePath_TwoSpool
      ((SFc3_GTF_EnginePath_TwoSpoolInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3898377520U));
  ssSetChecksum1(S,(2750177588U));
  ssSetChecksum2(S,(1321103120U));
  ssSetChecksum3(S,(822624814U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct *)utMalloc(sizeof
    (SFc3_GTF_EnginePath_TwoSpoolInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_GTF_EnginePath_TwoSpoolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_GTF_EnginePath_TwoSpool;
...
void c3_GTF_EnginePath_TwoSpool_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_GTF_EnginePath_TwoSpool(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_GTF_EnginePath_TwoSpool_method_dispatcher.\n"
