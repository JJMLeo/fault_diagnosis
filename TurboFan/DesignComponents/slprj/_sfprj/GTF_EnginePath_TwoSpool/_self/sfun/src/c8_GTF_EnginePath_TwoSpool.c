...
static const char * c8_debug_family_names[11] = { "WcoolLPT_PT", "nargin",
  "nargout", "W5", "Tt5", "WcoolLPT", "Tt_Z2", "Wf", "Tt51", "W51", "Sfcn51" };

static const char * c8_b_debug_family_names[9] = { "b_FuelAirRatio", "TE", "Hia",
  "Hif", "nargin", "nargout", "T", "FuelAirRatio", "Hi" };

static const char * c8_c_debug_family_names[10] = { "a", "b", "error", "hguess",
  "Z", "nargin", "nargout", "h", "f", "Tt" };

static const char * c8_d_debug_family_names[9] = { "T_lib", "psi_lib",
  "thetapsi_lib", "thetapsi", "nargin", "nargout", "f", "T", "Sfcn" };

static const char * c8_e_debug_family_names[14] = { "f", "Wcool_PT", "f_Mix",
  "h_Mix", "nargin", "nargout", "Tt_in", "W_in", "Tt_Cool_in", "Wcool_in", "Wf",
  "Tt_out", "Sfcn_out", "W_out" };

/* Function Declarations */
static void initialize_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initialize_params_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void enable_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void disable_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void set_sim_state_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void finalize_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void sf_gateway_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void mdl_start_c8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void initSimStructsc8_GTF_EnginePath_TwoSpool
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance);
static void c8_CoolingCal_PT(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c8_Tt_in, real_T c8_W_in, real_T c8_Tt_Cool_in, real_T
  c8_Wcool_in, real_T c8_b_Wf, real_T *c8_Tt_out, real_T *c8_Sfcn_out, real_T
  *c8_W_out);
static real_T c8_gashi(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
  real_T c8_T, real_T c8_FuelAirRatio);
static real_T c8_Sfcn_Ts(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c8_f, real_T c8_T);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, const mxArray *c8_b_Sfcn51, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
...
static void c8_eml_scalar_eg(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c8_interp1(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c8_varargin_3);
static real_T c8_interp1_work(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c8_xi);
static void c8_StringToMethodID(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static int32_T c8_intmin(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c8_eml_error(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void c8_b_eml_error(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static real_T c8_b_interp1(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance, real_T c8_varargin_1[181], real_T c8_varargin_2[181], real_T
  c8_varargin_3);
static void c8_flip(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                    real_T c8_x[181], real_T c8_b_x[181]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_c_emlrt_marshallIn(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_d_emlrt_marshallIn(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c8_b_is_active_c8_GTF_EnginePath_TwoSpool, const
  char_T *c8_identifier);
static uint8_T c8_e_emlrt_marshallIn(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_flip(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance,
                      real_T c8_x[181]);
static void init_dsm_address_info(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance);
  ...
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_GTF_EnginePath_TwoSpool = 0U;
}
   ...
   *c8_st)
{
  ...
  *chartInstance->c8_Sfcn51 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c8_u, 0)), "Sfcn51");
  *chartInstance->c8_Tt51 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c8_u, 1)), "Tt51");
  *chartInstance->c8_W51 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c8_u, 2)), "W51");
  chartInstance->c8_is_active_c8_GTF_EnginePath_TwoSpool = c8_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
     "is_active_c8_GTF_EnginePath_TwoSpool");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_GTF_EnginePath_TwoSpool(chartInstance);
  ...
  (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance)
{
  ...
  real_T c8_b_W5;
  real_T c8_b_Tt5;
  real_T c8_b_WcoolLPT;
  real_T c8_b_Tt_Z2;
  real_T c8_b_Wf;
  uint32_T c8_debug_family_var_map[11];
  real_T c8_WcoolLPT_PT;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_W5, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_Tt5, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_WcoolLPT, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_Tt_Z2, 3U);
  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 7U, chartInstance->c8_sfEvent);
  c8_hoistedGlobal = *chartInstance->c8_W5;
  c8_b_hoistedGlobal = *chartInstance->c8_Tt5;
  c8_c_hoistedGlobal = *chartInstance->c8_WcoolLPT;
  c8_d_hoistedGlobal = *chartInstance->c8_Tt_Z2;
  c8_e_hoistedGlobal = *chartInstance->c8_Wf;
  c8_b_W5 = c8_hoistedGlobal;
  c8_b_Tt5 = c8_b_hoistedGlobal;
  c8_b_WcoolLPT = c8_c_hoistedGlobal;
  c8_b_Tt_Z2 = c8_d_hoistedGlobal;
  c8_b_Wf = c8_e_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c8_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_WcoolLPT_PT, 0U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 2U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_b_W5, 3U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_b_Tt5, 4U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_b_WcoolLPT, 5U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_b_Tt_Z2, 6U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_b_Wf, 7U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_Tt51, 8U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_W51, 9U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_Sfcn51, 10U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 2);
  c8_WcoolLPT_PT = c8_b_WcoolLPT * 0.66666666666666663;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 3);
  c8_CoolingCal_PT(chartInstance, c8_b_Tt5, c8_b_W5, c8_b_Tt_Z2, c8_WcoolLPT_PT,
                   c8_b_Wf, &c8_c_Tt51, &c8_c_Sfcn51, &c8_c_W51);
  c8_b_Tt51 = c8_c_Tt51;
  c8_b_Sfcn51 = c8_c_Sfcn51;
  c8_b_W51 = c8_c_W51;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c8_Tt51 = c8_b_Tt51;
  *chartInstance->c8_W51 = c8_b_W51;
  *chartInstance->c8_Sfcn51 = c8_b_Sfcn51;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_Tt51, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_W51, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_Sfcn51, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c8_Wf, 7U);
}
  ...
  *c8_W_out)
{
  ...
  real_T c8_h;
  real_T c8_b_f;
  uint32_T c8_b_debug_family_var_map[10];
  real_T c8_a;
  real_T c8_b;
  real_T c8_error;
  real_T c8_hguess;
  ...
  real_T c8_y_x;
  real_T c8_ab_x;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c8_e_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_f, 0U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_Wcool_PT, 1U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_f_Mix, 2U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_h_Mix, 3U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 5U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_Tt_in, 6U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_W_in, 7U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_Tt_Cool_in, 8U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_Wcool_in, 9U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_Wf, 10U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_Tt_out, 11U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_Sfcn_out, 12U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_W_out, 13U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, 3);
  c8_A = c8_b_Wf;
  c8_B = c8_W_in - c8_b_Wf;
  c8_x = c8_A;
  c8_y = c8_B;
  c8_b_x = c8_x;
  c8_b_y = c8_y;
  ...
  c8_Wcool_PT = c8_Wcool_in;
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, 9);
  c8_b_A = c8_b_Wf;
  c8_b_B = (c8_W_in + c8_Wcool_PT) - c8_b_Wf;
  c8_d_x = c8_b_A;
  c8_d_y = c8_b_B;
  c8_e_x = c8_d_x;
  c8_e_y = c8_d_y;
  c8_f_x = c8_e_x;
  c8_f_y = c8_e_y;
  c8_f_Mix = c8_f_x / c8_f_y;
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, 12);
  c8_c_A = c8_W_in * c8_gashi(chartInstance, c8_Tt_in, c8_f) + c8_Wcool_PT *
    c8_gashi(chartInstance, c8_Tt_Cool_in, 0.0);
  c8_c_B = c8_W_in + c8_Wcool_PT;
  c8_g_x = c8_c_A;
  c8_g_y = c8_c_B;
  c8_h_x = c8_g_x;
  c8_h_y = c8_g_y;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_a, 0U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b, 1U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_error, 2U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_hguess, 3U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_Z, 4U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_nargin, 5U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_nargout, 6U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_h, 7U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_f, 8U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_Tt_out, 9U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  ...
  while (CV_SCRIPT_WHILE(2, 0, c8_error > 1.0E-12)) {
    ...
    c8_l_x = c8_k_x;
    c8_j_y = c8_l_x / 2.0;
    c8_hguess = c8_gashi(chartInstance, c8_j_y, c8_b_f);
    _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, 7);
    c8_e_A = c8_hguess - c8_h;
    c8_d_B = c8_h;
    c8_m_x = c8_e_A;
    c8_k_y = c8_d_B;
    c8_n_x = c8_m_x;
    ...
    c8_o_x = c8_n_x;
    c8_m_y = c8_l_y;
    c8_n_y = c8_o_x / c8_m_y;
    c8_p_x = c8_n_y;
    c8_q_x = c8_p_x;
    c8_error = muDoubleScalarAbs(c8_q_x);
    _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, 8);
    c8_Z = c8_hguess - c8_h;
    _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, 9);
    if (CV_SCRIPT_IF(2, 0, CV_RELATIONAL_EVAL(14U, 2U, 0, c8_Z, 0.0, -1, 5U,
          c8_Z >= 0.0))) {
      ...
      _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, 12);
      c8_g_A = c8_a + c8_b;
      c8_u_x = c8_g_A;
      c8_v_x = c8_u_x;
      c8_w_x = c8_v_x;
  ...
  _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, 15);
  c8_h_A = c8_a + c8_b;
  c8_x_x = c8_h_A;
  c8_y_x = c8_x_x;
  c8_ab_x = c8_y_x;
  *c8_Tt_out = c8_ab_x / 2.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c8_sfEvent, -15);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, 18);
  *c8_Sfcn_out = c8_Sfcn_Ts(chartInstance, c8_f_Mix, *c8_Tt_out);
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, 21);
  *c8_W_out = c8_W_in + c8_Wcool_PT;
  _SFD_SCRIPT_CALL(0U, chartInstance->c8_sfEvent, -21);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  real_T c8_T, real_T c8_FuelAirRatio)
{
  ...
  if (CV_SCRIPT_IF(1, 0, CV_RELATIONAL_EVAL(14U, 1U, 0, c8_FuelAirRatio, 0.0, -1,
  ...
  if (CV_SCRIPT_IF(1, 1, CV_RELATIONAL_EVAL(14U, 1U, 1, c8_FuelAirRatio,
        0.067623, -1, 4U, c8_FuelAirRatio > 0.067623))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 11);
    c8_FuelAirRatio = 0.067623;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 14);
  c8_b_FuelAirRatio = 0.0;
  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 16);
  if (CV_SCRIPT_IF(1, 2, CV_RELATIONAL_EVAL(14U, 1U, 2, c8_FuelAirRatio, 0.0, -1,
        0U, c8_FuelAirRatio == 0.0))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 17);
    c8_b_FuelAirRatio = 1.0;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 21);
  c8_A = c8_T * 9.0;
  c8_x = c8_A;
  c8_b_x = c8_x;
  c8_c_x = c8_b_x;
  c8_TE = c8_c_x / 5.0;
  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 22);
  if (CV_SCRIPT_IF(1, 3, CV_RELATIONAL_EVAL(14U, 1U, 3, c8_TE, 300.0, -1, 2U,
        c8_TE < 300.0))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 23);
    c8_TE = 300.0;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 26);
  if (CV_SCRIPT_IF(1, 4, CV_RELATIONAL_EVAL(14U, 1U, 4, c8_TE, 4000.0, -1, 4U,
        c8_TE > 4000.0))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 27);
    c8_TE = 4000.0;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 31);
  c8_Hia = (((((((1.2644425E-26 * c8_TE - 2.0752522E-22) * c8_TE + 1.270263E-18)
    ...
    - 1.7558886;
  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 33);
  switch ((int32_T)_SFD_INTEGER_CHECK("b_FuelAirRatio", c8_b_FuelAirRatio)) {
   case 1:
    CV_SCRIPT_SWITCH(1, 0, 1);
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 38);
    c8_Hi = c8_Hia * 2.3254259;
    break;

   default:
    CV_SCRIPT_SWITCH(1, 0, 0);
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 42);
    ...
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 43);
    ...
    _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 46);
    c8_Hi = c8_Hif * 2.3254259;
    break;
  }

  _SFD_SCRIPT_CALL(1U, chartInstance->c8_sfEvent, 48);
  c8_b_A = c8_TE * 5.0;
  c8_d_x = c8_b_A;
  c8_e_x = c8_d_x;
  c8_f_x = c8_e_x;
  ...
  *chartInstance, real_T c8_f, real_T c8_T)
{
  ...
  real_T c8_c_y;
  real_T c8_d_y;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 10U, c8_d_debug_family_names,
    c8_debug_family_var_map);
  ...
  _SFD_SCRIPT_CALL(3U, chartInstance->c8_sfEvent, 8);
  c8_A = c8_f;
  c8_B = 1.0 + c8_f;
  c8_x = c8_A;
  c8_y = c8_B;
  ...
  c8_chartNumber, uint32_T c8_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c8_chartNumber, c8_instanceNumber, 3U,
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  chartInstance = (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c8_b_Sfcn51, const char_T *c8_identifier)
{
  ...
  c8_y = c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_b_Sfcn51),
    &c8_thisId);
  sf_mex_destroy(&c8_b_Sfcn51);
  return c8_y;
}
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  chartInstance = (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *)
    chartInstanceVoid;
  c8_b_Sfcn51 = sf_mex_dup(c8_mxArrayInData);
...
const mxArray *sf_c8_GTF_EnginePath_TwoSpool_get_eml_resolved_functions_info
  (void)
{
  const mxArray *c8_nameCaptureInfo = NULL;
  c8_nameCaptureInfo = NULL;
  sf_mex_assign(&c8_nameCaptureInfo, sf_mex_createstruct("structure", 2, 115, 1),
                false);
...
static void c8_info_helper(const mxArray **c8_info)
{
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("CoolingCal_PT"), "name",
                  "name", 7);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_PT.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1455934063U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_PT.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("mrdivide"), "name", "name", 8);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_PT.m"), "context",
                  "context", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("gashi"), "name", "name", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("mrdivide"), "name", "name", 10);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_PT.m"), "context",
                  "context", 11);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("Tt_h"), "name", "name", 11);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/Tt_h.m"), "resolved", "resolved", 11);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(1455934324U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c8_info, c8_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("gashi"), "name", "name", 13);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[E]I:/MATLABWORK/GTF/FunctionsLibrary/CoolingCal_PT.m"), "context",
                  "context", 17);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("Sfcn_Ts"), "name", "name", 17);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("colon"), "name", "name", 18);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 20);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isfinite"), "name", "name", 20);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isinf"), "name", "name", 22);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 24);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isnan"), "name", "name", 24);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 26);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 26);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkFlintRange"),
                  "context", "context", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("flintmax"), "name", "name", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkFlintRange"),
                  "context", "context", 33);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("abs"), "name", "name", 33);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("realmax"), "name", "name", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon"),
                  "context", "context", 40);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmax"), "name", "name", 40);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("interp1"), "name", "name", 42);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 47);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("length"), "name", "name", 47);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("max"), "name", "name", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!StringToMethodID"),
                  "context", "context", 56);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("strncmpi"), "name", "name", 56);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 56);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 60);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("min"), "name", "name", 60);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 60);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/strncmpi.m"), "context",
                  "context", 62);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("lower"), "name", "name", 62);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 62);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
...
static void c8_b_info_helper(const mxArray **c8_info)
{
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 67);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("colon"), "name", "name", 67);
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 68);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("colon"), "name", "name", 68);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 70);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 70);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 71);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmin"), "name", "name", 71);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 73);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmax"), "name", "name", 73);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 74);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmin"), "name", "name", 74);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 87);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isfi"), "name", "name", 87);
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 89);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmax"), "name", "name", 89);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 89);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 90);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmin"), "name", "name", 90);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 90);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                  "context", "context", 91);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "name", "name", 91);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("int8"), "dominantType",
                  "dominantType", 91);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 95);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isnan"), "name", "name", 95);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 95);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1Linear"),
                  "context", "context", 97);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("isnan"), "name", "name", 97);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 97);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 101);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 101);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 101);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/bsearch.p"),
                  "context", "context", 103);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmax"), "name", "name", 103);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 103);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/polyfun/interp1.m!interp1_work"),
                  "context", "context", 105);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("flip"), "name", "name", 105);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 105);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 110);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 110);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 110);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assertValidDim.m"),
                  "context", "context", 111);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("intmax"), "name", "name", 111);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 111);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_GTF_EnginePath_TwoSpool), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_GTF_EnginePath_TwoSpool);
  return c8_y;
}
...
static void init_simulink_io_address(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *
  chartInstance)
{
  chartInstance->c8_W5 = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c8_Tt5 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c8_WcoolLPT = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c8_Tt_Z2 = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c8_Tt51 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c8_W51 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c8_Sfcn51 = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c8_Wf = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    4);
}
...
void sf_c8_GTF_EnginePath_TwoSpool_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(72636878U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2711109885U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3275329381U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2025061871U);
}

mxArray* sf_c8_GTF_EnginePath_TwoSpool_get_post_codegen_info(void);
mxArray *sf_c8_GTF_EnginePath_TwoSpool_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("gvn6DN7SVva4PlLiKZrOIB");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c8_GTF_EnginePath_TwoSpool_get_post_codegen_info();
...
mxArray *sf_c8_GTF_EnginePath_TwoSpool_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_GTF_EnginePath_TwoSpool_jit_fallback_info(void)
{
...
mxArray *sf_c8_GTF_EnginePath_TwoSpool_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_GTF_EnginePath_TwoSpool(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"Sfcn51\",},{M[1],M[5],T\"Tt51\",},{M[1],M[10],T\"W51\",},{M[8],M[0],T\"is_active_c8_GTF_EnginePath_TwoSpool\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_GTF_EnginePath_TwoSpool_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"W5");
          _SFD_SET_DATA_PROPS(1,1,1,0,"Tt5");
          _SFD_SET_DATA_PROPS(2,1,1,0,"WcoolLPT");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Tt_Z2");
          _SFD_SET_DATA_PROPS(4,2,0,1,"Tt51");
          _SFD_SET_DATA_PROPS(5,2,0,1,"W51");
          _SFD_SET_DATA_PROPS(6,2,0,1,"Sfcn51");
          _SFD_SET_DATA_PROPS(7,1,1,0,"Wf");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(7,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c8_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c8_W5);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c8_Tt5);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c8_WcoolLPT);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c8_Tt_Z2);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c8_Tt51);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c8_W51);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c8_Sfcn51);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c8_Wf);
      }
    } else {
...
{
  return "7wp3dj1vOEfCQgYOo7FDWE";
}

static void sf_opaque_initialize_c8_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
  initialize_c8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  enable_c8_GTF_EnginePath_TwoSpool((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  disable_c8_GTF_EnginePath_TwoSpool((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_GTF_EnginePath_TwoSpool(void *chartInstanceVar)
{
  sf_gateway_c8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_GTF_EnginePath_TwoSpool
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_GTF_EnginePath_TwoSpool(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c8_GTF_EnginePath_TwoSpool(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_GTF_EnginePath_TwoSpool
      ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_GTF_EnginePath_TwoSpool
    ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_GTF_EnginePath_TwoSpool
      ((SFc8_GTF_EnginePath_TwoSpoolInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2777830974U));
  ssSetChecksum1(S,(131039746U));
  ssSetChecksum2(S,(409130157U));
  ssSetChecksum3(S,(4283585137U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_GTF_EnginePath_TwoSpool(SimStruct *S)
{
  SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct *)utMalloc(sizeof
    (SFc8_GTF_EnginePath_TwoSpoolInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_GTF_EnginePath_TwoSpoolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_GTF_EnginePath_TwoSpool;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_GTF_EnginePath_TwoSpool;
...
void c8_GTF_EnginePath_TwoSpool_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_GTF_EnginePath_TwoSpool(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_GTF_EnginePath_TwoSpool(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_GTF_EnginePath_TwoSpool_method_dispatcher.\n"
